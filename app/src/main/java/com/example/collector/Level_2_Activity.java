...
public class Level_2_Activity extends Activity {
    ...
    //Images
    private ImageView stickBg, basket, worm, redApple, lemon;
    ...
    private int score;
    private final int current_level_req_score = 200;
    ...
    public void win()
    {
        ...
        Intent scoreIntent_win = new Intent(Level_2_Activity.this, level_up_class.class);
        ...
        Level_2_Activity.super.onBackPressed();
    }

    public void lose()
    {
        Intent scoreIntent_lose = new Intent(Level_2_Activity.this, CurrentScore_class.class);
    ...
    public void exit()
    {
        final AlertDialog.Builder builder = new AlertDialog.Builder(Level_2_Activity.this);
        ...
        builder.setPositiveButton(getResources().getString(R.string.yes), new DialogInterface.OnClickListener()
        {
            ...
            public void onClick(DialogInterface dialog, int which)
            {
                if(levelsflag)
                {
                    Intent intent_play = new Intent(Level_2_Activity.this,Levels_class.class);
                    startActivity(intent_play);
                }
                else
                {
                    Intent menuIntent = new Intent(Level_2_Activity.this, MainActivity.class);
    ...
    protected void onResume()
    {
        ...
        if(musicCounter == 0)
        {
            ...
            } else
            {
                doBindService();
                Intent music = new Intent();
                music.setClass(Level_2_Activity.this, MusicPlayer.class);
                startService(music);
                if (mServ != null)
                {
                    mServ.resumeMusic();
    ...
    public void setting (View view)
    {
        ...
        final AlertDialog.Builder alertSetting = new AlertDialog.Builder(Level_2_Activity.this);
